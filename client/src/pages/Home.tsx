...
const featuredCases = [
  ...
  { key: "agro", index: "03", type: "edutec · agronegócio + IA", title: "AgroVanguard", headline: "Conhecimento aplicado para um setor que não para.", text: "Um conceito de edutec para aproximar formação, agronegócio e tecnologia em uma experiência mais acessível.", result: "site público indisponível no momento · mockup conceitual", href: "https://www.agrovanguard.com.br", domain: "agrovanguard.com.br" },
